...
private struct PostgresDialect: SQLDialect {
    public init() { }
    ...
    var createTriggerSupportsCondition = true
    var createTriggerSupportsForEach = true
    var createTriggerPostgreSqlChecks = true
    var createTriggerSupportsConstraint = true
    var createTriggerSupportsUpdateColumns = true
    var dropTriggerSupportsCascade = true
    var dropTriggerSupportsTableName = true
}
