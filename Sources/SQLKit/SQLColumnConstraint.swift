...
extension SQLColumnConstraint {
    ...
    public static func references(
        _ table: Algorithm.ForeignKey.TableIdentifier,
        _ column: Algorithm.ForeignKey.Identifier,
        onDelete: Algorithm.ForeignKey.Action? = nil,
        onUpdate: Algorithm.ForeignKey.Action? = nil,
        identifier: Identifier? = nil
    ) -> Self {
        return references(table, [column], onDelete: onDelete, onUpdate: onUpdate, identifier: identifier)
    }
