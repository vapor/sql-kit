public protocol SQLLiteral: SQLSerializable {
    ...
    static func rawString(_ string: String) -> Self
    ...
    DefaultLiteral: SQLDefaultLiteral, BoolLiteral: SQLBoolLiteral
{
    ...
    /// See `SQLLiteral`.
    public static func rawString(_ string: String) -> GenericSQLLiteral {
        return ._rawString(string)
    }
    ...
    public func serialize(_ binds: inout [Encodable]) -> String {
        ...
        case ._rawString(let string): return string
        }
    }
}
